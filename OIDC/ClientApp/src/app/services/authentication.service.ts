...
import { BehaviorSubject, combineLatest, Observable, ReplaySubject, timer, interval } from 'rxjs';
...
@Injectable() export class AuthenticationService {
  ...
  public myrecordrefresh() {
    ...
    window.addEventListener('storage', (event) => {
      ...
      this.signinStatus.next(this.oAuthService.hasValidAccessToken());
